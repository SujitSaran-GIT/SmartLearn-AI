                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        {currentQuestion.difficulty && (
                          <span className={`px-3 py-1 rounded-full text-sm font-semibold ${currentQuestion.difficulty === 'easy' ? 'bg-success-100 text-success-700' :
                    ...
                    <button
                      ...
                      className={`ml-4 p-2 rounded-lg transition-colors ${flaggedQuestions.has(currentQuestionIndex)
                  ...
                  {currentQuiz.questions.map((q, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`aspect-square rounded-lg font-semibold text-sm transition-all relative ${isCurrent
